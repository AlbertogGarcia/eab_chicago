...
OUTCOMES
- get remainder of reportcard data

TREE COVER
- NLCD data
-- get baseline tree cover
- ASH density
...
## Heterogeneity: wealth disparities in tree cover and education impacts
...
# Dose response: evidence from instrumental variables
