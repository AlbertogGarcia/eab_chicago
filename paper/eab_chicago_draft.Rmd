...
Figure \@ref(fig:schart-test) shows the estimated impacts of confirmed EAB infestation on ISAT test performance across a variety of subjects and grade levels. We see that confirmed EAB infestation in the vicinity of schools has a negative impact on that school's ISAT scores. Note that while Math performance seems to suffer, there is no statistically significant impact on Reading. Further, there are impacts across a variety of ages and grade levels. 
